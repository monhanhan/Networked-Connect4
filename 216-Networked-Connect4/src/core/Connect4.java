...
public class Connect4 {
	...
	public boolean checkVictory() {
		...
		return (checkDown() || checkLeft() || checkRight() || checkUL()
				|| checkUR() || checkDL() || checkDR());
	 ...
	 * 
	 * @return This returns a boolean value indicating if all spaces are full
	 *         and there is a tie.
	 */
	...
	private boolean checkDown() {
		...
		while (currPosY < 6) {
			// If we don't find the player's piece, they can't have won in this
			// direction.
	...
	/**
	 * This checks if there is a victory to the right of the most recently
	 * placed piece.
	 * 
	 * @return is a boolean value indicating a victory.
	 */
	...
	/**
	 * This checks if there is a victory diagonal to the up and right of the
	...
	/**
	 * This checks if there is a victory diagonal to the down and left of the
	 * most recently placed piece.
	 * 
	 * @return is a boolean value indicating a victory.
	 */
	...
	/**
	 * This checks if there is a victory diagonal to the down and right of the
	 * most recently placed piece.
	 * 
	 * @return is a boolean value indicating a victory.
	 */
	 ...
	 * @return is an int value representing the row to which a piece will be
	 *         added. a value of -1 indicates that a column is full.
	 */
	private int findLowestRow(int col) {
		int currSpot = -1;

		// if the top position is empty return -1 so we know this column is
		// full.
		if (board[0][col] != ' ') {
			return currSpot;
			...
			while (currSpot < 5) {
				// Check if the next lowest spot is empty. If not, break the
				// loop
				if (board[currSpot + 1][col] != ' ') {
					break;
				}

				// if the next lowest spot is empty, start the loop again from
				// that spot
				currSpot = currSpot + 1;
	...
	/**
	 * This returns the 2d array representation of the board for display
	 * elsewhere.
	 * 
